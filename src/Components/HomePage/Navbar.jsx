...
const Navbar = () => {
  ...
  return (
    ...
    <div className='max-[768px]:hidden'>
     <div className='flex justify-around items-center rounded-full my-4 text-white bg-[rgba(0,0,0,0.3)] sm:w-[50%] ml-[25%] py-2'>
    ...
    <div onClick={handleClick}>
        {isMenuOpen ? (
        <div className='min-[768px]:hidden flex flex-col justify-center items-center my-4 bg-[rgba(0,0,0,0.3)] w-[20%] ml-[40%] py-2 rounded-full'>

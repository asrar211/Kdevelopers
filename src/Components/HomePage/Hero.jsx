...
const Hero = () => {
  return (
    ...
    <div className='min-[900px]:hidden w-[15rem] h-[15rem] bg-yellow-500 absolute translate-x-[50%] translate-y-[-50%] top-[0%] left-[0%] z-[-1] blur-[3rem] rounded-full'></div>
    <div className='min-[900px]:hidden w-[15rem] h-[15rem] bg-blue-800 absolute translate-x-[-50%] translate-y-[-50%] top-[50%] left-[50%] z-[-1] blur-[3rem] rounded-full'></div>
